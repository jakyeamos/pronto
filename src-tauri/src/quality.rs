...
mod tests {
  ...
  "dispositions": [
    ...
    fn ingests_qr_gates_and_severity_breakdown_without_running_commands() {
        ...
        let observed_at = (Utc::now() - Duration::days(1)).to_rfc3339();
        ...
        fs::write(
            ...
            serde_json::json!({"gates": [
                {"id": "runtime_smoke", "status": "passed", "capability_kind": "local_command", "command": "pnpm smoke", "completed_at": observed_at},
