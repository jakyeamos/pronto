...
| Research Domain Writing    | Gated           | GitHub → source-to-claim case → DEV.to → daily.dev → LinkedIn → Handshake  | Hacker News only as a regular technical submission if appropriate | RDW-0 release-source attestation and editorial approval                 |
...
| AI Workflow Leverage       | Deferred        | GitHub → portfolio → LinkedIn → Handshake                                  | DEV.to, daily.dev, Product Hunt after AL-2                        | Append-only runtime event contract                                      |
| Marketing Autoresearch     | Deferred        | GitHub → portfolio → DEV.to → daily.dev → LinkedIn → Handshake             | Product Hunt only if a stable user product emerges                | MA-2 brief-aware source-to-claim receipts                               |
| RemodelVision              | Gated           | GitHub → visual case → LinkedIn → Handshake                                | Product Hunt, targeted Reddit                                     | RV-1 contribution and owner-approval ledger                             |
...
| Book                       | Gated           | GitHub → interactive-media case → LinkedIn → Handshake                     | No broad launch channel until rights are clear                    | BK-1 chapter rights and attribution ledger                              |
