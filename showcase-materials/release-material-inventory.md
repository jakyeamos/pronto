...
- **34** active `public_showcase` repositories are in the release matrix,
  ...
  2026-08-13.
- **122** current material/gap entries are open across the 34 active targets
...
| Research Domain Writing    | Gated         | gated / gated / gated                   | Local real-case package and reviewed 16:9 preview are complete; release-source attestation or rebuild; editorial approval; no-auth hosted verification remain open                               | DEV.to, daily.dev, LinkedIn planned                             | RDW-0 bind the installed artifact to the intended source revision, then complete editorial review  |
...
| AI Workflow Leverage       | Deferred      | planned / deferred / deferred           | Local AL-1/AL-7 protocol and case package now include claim ledger, no-auth source, and reviewed 16:9 preview; credible paired outcome, hosted no-auth URL, and external destination readbacks remain open | DEV.to, daily.dev, Product Hunt, LinkedIn deferred              | AL-2 approved append-only event contract owned by `agent-eval-runtime`                             |
| Marketing Autoresearch     | Deferred      | planned / deferred / deferred           | Local MA-1/MA-7 package now includes real brief, privacy review, synthetic refusal appendix, claim ledger, no-auth source, and reviewed 16:9 binary; brief-aware shadow receipt, report, runtime refusal receipt, hosted URL, and destination readbacks remain open | DEV.to, daily.dev, Product Hunt, LinkedIn deferred              | MA-2 brief-aware source-to-claim receipt contract, then rerun the public brief                     |
| RemodelVision              | Gated         | gated / gated / gated                   | Local synthetic constraint case, claim ledger, no-auth source, and reviewed 16:9 binary are complete; contribution approval, current runnable proof, hosted URL, and destination readbacks remain open | Product Hunt, Reddit, LinkedIn planned                          | RV-1 explicit owner/collaborator approval; RV-3 current runtime proof remains separate             |
...
| Book                       | Gated         | gated / gated / gated                   | Local synthetic reader-to-media case, claim ledger, no-auth source, and reviewed 16:9 binary are complete; chapter/asset rights, AI/human role, direct reader proof, hosted URL, and readbacks remain open | LinkedIn planned; no broad launch until rights clear            | BK-1 complete the representative chapter rights and attribution ledger                             |
