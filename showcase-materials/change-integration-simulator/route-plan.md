...
Status: C0 public Showcase admission is complete; clean/conflict simulation and
gate proof remain gated.
...
All frames below are **concept frames** until clean, conflict, stale,
cancellation, and retained-dirty cases pass.
...
Reviewed baseline: the W4 integration MVP records immutable source/target
resolution and merge-tree receipts without ref mutation. Clean/conflict
scenarios and Gateboard evidence remain open.
...
| ----- | ----------------------------------------- | -------------------------------------------------------------------------------- | ----------------- | --------------------------------- |
| CIS-0 | Prove clean/conflict simulation           | Clean and conflict source/target cases produce bounded merge-tree receipts       | Integration owner | Simulation matrix                 |
...
| CIS-3 | Package the public case                   | Preview, short copy, no-auth integration case, and proof link agree              | Showcase owner    | Material review and readback      |
